...
class InferlessPythonModel:
    ...
    def initialize(self):
        self.generator = pipeline("text-generation", model="unsloth/DeepSeek-R1-Distill-Llama-8B-unsloth-bnb-4bit", torch_dtype=torch.float16, device_map="auto", llm_int8_enable_fp32_cpu_offload=True)
